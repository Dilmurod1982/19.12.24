...
import { AddNewProdInsurance, ProdInsuranceList } from "../components";
...
function ProdInsurance() {
  ...
  const exportToExcel = () => {
    const filteredDocs = filteredDocs();
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "ProdInsurance");

    // Скачивание файла
    XLSX.writeFile(workbook, "Prodinsurance.xlsx");
  };
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-between gap-1">
          <div className="flex justify-between w-full px-4">
            <h1 className="text-3xl font-bold">
              Хавфли ишлаб чиқариш полислари рўйхати
            </h1>
            {user.type === "admin" ? (
              <Button
                onClick={setAddItemModal}
                disabled={prodinsurance ? false : true}
                className={
                  prodinsurance ? "cursor-pointer" : "cursor-not-allowed"
                }
              >
                Янги полис қўшиш
              </Button>
            ...
            <div className="flex items-end gap-10 justify-between w-full">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex gap-5">
                  ...
                  <Input
                    type="text"
                    placeholder="Полис рақами билан"
                    value={searchTerm}
        ...
        <table className="table table-xs">
          <thead>
            <tr>
              ...
              <th className="text-center">Полис рақами</th>
