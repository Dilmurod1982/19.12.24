...
import KolonkaList from "../components/kolonka/KolonkaList";
...
function Kolonka() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "KOLONKA"); //zamena

    XLSX.writeFile(workbook, "kolonka.xlsx"); //zamena
  };
  return (
    <>
      <div className="overflow-x-auto">
        <div className="flex flex-col items-center justify-between gap-1">
          <div className="flex justify-between w-full px-4">
            <h1 className="text-3xl font-bold">Колонкалар сертификатлари</h1>
            {user.type === "admin" ? (
              <Button
                onClick={setAddItemModal}
                disabled={kolonka ? false : true} //zamena
                className={kolonka ? "cursor-pointer" : "cursor-not-allowed"} //zamena
              >
        ...
        <table className="table table-xs">
          <thead>
            <tr>
              ...
              <th className="text-center">Колонкалар сони</th>
