...
import EcologyList from "../components/Ecology/EcologyList";
...
function EcologyTwo() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Ecology");

    XLSX.writeFile(workbook, "ecology.xlsx");
  };
  return (
    <>
      <div className="overflow-x-auto">
        <div className="flex flex-col items-center justify-between gap-1">
          <div className="flex justify-between w-full px-4">
            <h1 className="text-3xl font-bold">Экология хулосалари рўйхати</h1>
            {user.type === "admin" ? (
              <Button
                onClick={setAddItemModal}
                disabled={ecology ? false : true}
                className={ecology ? "cursor-pointer" : "cursor-not-allowed"}
              >
                Янги хулоса қўшиш
              </Button>
            ) : null}
            ...
            <div className="flex items-end gap-10 justify-between w-full">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex gap-5">
                  ...
                  <Input
                    type="text"
                    placeholder="Хулоса рақами билан"
                    value={searchTerm}
        ...
        <table className="table table-xs">
          <thead>
            <tr>
              ...
              <th className="text-center">Хулоса рақами</th>
