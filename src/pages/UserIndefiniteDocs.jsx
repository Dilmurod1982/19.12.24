...
export default function UserIndefiniteDocs() {
  ...
  const docTypes = {
    hokim: "Хоким қарори",
    contract: "Олди-сотди шартномаси",
    apz: "АПЗ хужжати",
    gastx: "Табиий газ техник шарти",
    elektrtx: "Электр техник шарти",
    suvtx: "Сув техник шарти",
    gasloyiha: "Ташқи газ қувури лойихаси",
    elektrloyiha: "Электр тармоғи лойихаси",
    suvloyiha: "Сув тармоғи лойиҳаси",
    inshloyiha: "Заправка лойиҳаси",
    inshexpertiza: "Заправка лойиҳаси экспертизаси",
    prodexpertiza: "Саноат хавфсилиги экспертизаси",
    iden: "Идентификация",
    foyda: "Фойдаланишга қабул қилиш далолатномаси",
  };
  ...
  const allDocuments = [
    ...
    ...suvtx.map((doc) => ({ ...doc, document_type: "suvtx" })),
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <table className="table table-xs">
        ...
        <tbody>
          {filteredDocuments.map((doc, index) => (
            <tr key={`doc-${doc.id || doc.document_type}-${index}`}>
              <td>{index + 1}</td>
      ...
      <div className="flex w-full justify-center mt-5 lg:hidden">
        <Link to={`/usernewindefinitedocs/${stationId}`} className="btn btn-neutral">
          Янги хужжат қўшиш
        </Link>
      </div>

      <div className="flex justify-center items-center py-5">
        <Link to="/userindefinite">
