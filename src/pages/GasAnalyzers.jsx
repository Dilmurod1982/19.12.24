...
import { AddNewGasAnalyzer, GasAnalyzersList } from "../components";
...
function GasAnalyzers() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "GasAnalyzer");

    // Скачивание файла
    XLSX.writeFile(workbook, "gasanalyzer.xlsx");
  };
  return (
    <>
          ...
          <div className="flex justify-between w-full px-4">
            ...
            {user.type === "admin" ? (
              <Button
                ...
                disabled={gasanalyzers ? false : true}
                className={
                  gasanalyzers ? "cursor-pointer" : "cursor-not-allowed"
                }
              >
              ...
              <tr>
                <td colSpan="7" className="text-center">
                  <h1 className="my-5 btn-link text-2xl italic">
                    Газ анализатор сертификатлари мавжуд эмас
                  </h1>
                </td>
              </tr>
            )}
