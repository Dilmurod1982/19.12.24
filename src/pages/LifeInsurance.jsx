...
import AddNewLifeInsurance from "../components/lifeinsurance/AddNewLifeInsurance";
...
function LifeInsurance() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "LifeInsurance");

    // Скачивание файла
    XLSX.writeFile(workbook, "lifeinsurance.xlsx");
  };
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-between gap-1">
          <div className="flex justify-between w-full px-4">
            <h1 className="text-3xl font-bold">
              Ходимларни хаётини суғурталаш полислари рўйхати
            </h1>
            {user.type === "admin" ? (
              <Button
                onClick={setAddItemModal}
                disabled={lifeinsurance ? false : true}
                className={
                  lifeinsurance ? "cursor-pointer" : "cursor-not-allowed"
                }
              >
                Янги полис қўшиш
              </Button>
