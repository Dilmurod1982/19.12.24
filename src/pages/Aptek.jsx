...
function Aptek() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "aptechka"); //zamena

    XLSX.writeFile(workbook, "aptechka.xlsx"); //zamena
  };
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-between gap-1">
          <div className="flex justify-between w-full px-4">
            <h1 className="text-3xl font-bold">
              Аптечкани тўлдириш ва текшириш далолатномалари
            </h1>
            {user.type === "admin" ? (
              <Button
                onClick={setAddItemModal}
                disabled={aptek ? false : true} //zamena
                className={aptek ? "cursor-pointer" : "cursor-not-allowed"} //zamena
              >
        ...
        <table className="table table-xs">
          <thead>
            <tr>
              ...
              <th className="text-center">Далолатнома рақами</th>
      ...
      <AddNewAptek sendingData={sendingData} setSendingData={setSendingData} />
