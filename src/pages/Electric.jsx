...
function Electric() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "ELECTRIC"); //zamena

    XLSX.writeFile(workbook, "electric.xlsx"); //zamena
  };
  return (
    <>
          ...
          <div className="flex justify-between w-full px-4">
            ...
            {user.type === "admin" ? (
              <Button
                ...
                disabled={electric ? false : true} //zamena
                className={electric ? "cursor-pointer" : "cursor-not-allowed"} //zamena
              >
