...
export default function PilotDetail() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/pilot/${id}`, {
        //zamena
        method: "PATCH",
        headers: {
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">Автопилот сертификати</h1>
      </div>
      <div className="pl-10 flex flex-col gap-4">
        ...
        <h1>
          <span className="font-bold">Автопилот сертификати рақами:</span>{" "}
          {isEditing ? (
            <input
              type="text"
