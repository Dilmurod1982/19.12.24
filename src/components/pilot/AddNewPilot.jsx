...
export default function AddNewPilot({ setSendingData, sendingData }) {
  ...
  }, [sendingData, pilot, user, setAddItemModal, setPilot]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги Автопилот сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
