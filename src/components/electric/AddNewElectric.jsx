...
export default function AddNewElectric({ setSendingData, sendingData }) {
  ...
  }, [sendingData, electric, user, setAddItemModal, setElectric]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги электр ҳисоблагич сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
