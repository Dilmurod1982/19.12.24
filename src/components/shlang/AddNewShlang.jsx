...
export default function AddNewShlang({ setSendingData, sendingData }) {
  ...
  }, [sendingData, shlang, user, setAddItemModal, setShlang]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги газ тўлдириш шланги далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
                ...
                <Popover>
                  ...
                  <PopoverContent align="start" className="w-auto">
                    <Calendar
                      ...
                      onSelect={
                        (date) => handleDateChange("expiration", date) //.toISOString()
                      }
                    />
                  </PopoverContent>
                </Popover>
