...
export default function AddNewAptek({ setSendingData, sendingData }) {
  ...
  }, [sendingData, aptek, user, setAddItemModal, setAptek]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги аптечка текшириш далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
