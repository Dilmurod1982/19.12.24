...
export default function GasAnalyzerDetail() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/gasanalyzers/${id}`, {
        method: "PATCH",
        headers: {
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">ГАЗ АНАЛИЗАТОР СЕРТИФИКАТИ</h1>
      </div>
