...
export default function AddNewVoltmetr({ setSendingData, sendingData }) {
  ...
  }, [sendingData, voltmetr, user, setAddItemModal, setVoltmetr]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги амперметр ва вольтметр сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
