  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">ЛИЦЕНЗИЯ</h1>
      </div>
      <div className="pl-10 flex flex-col gap-4">
        <h1>
          <span className="font-bold">Лицензия эгаси:</span> {ltd_name} АГТКШ №{" "}
          {station_number}
        </h1>
        <h1>
        ...
        <h1>
          <span className="font-bold">Лицензия рақами:</span>{" "}
          {isEditing ? (
            <input
              type="text"
        ...
        <h1>
          <span className="font-bold">Лицензия берилган сана:</span>{" "}
          {isEditing ? (
            <input
              type="date"
        ...
        <h1>
          <span className="font-bold">Лицензия муддати тугаш санаси:</span>{" "}
          {isEditing ? (
            <input
              type="date"
        ...
        <h1>
          <span className="font-bold">Лицензия холати:</span>{" "}
