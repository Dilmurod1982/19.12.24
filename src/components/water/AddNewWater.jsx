...
export default function AddNewWater({ setSendingData, sendingData }) {
  ...
  }, [sendingData, water, user, setAddItemModal, setWater]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги Сув ҳисоблагич сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
