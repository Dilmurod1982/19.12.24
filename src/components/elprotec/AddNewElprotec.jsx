...
export default function AddNewElprotec({ setSendingData, sendingData }) {
  ...
  }, [sendingData, elprotec, user, setAddItemModal, setElprotec]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги электр ҳимоя воситалари синов далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
