...
export default function EducDetail() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/educ/${id}`, {
        method: "PATCH",
        headers: {
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">
          Саноат хавфсизилиги бўйича ходимларни ўқитиш баённомаси
        </h1>
      </div>
      <div className="pl-10 flex flex-col gap-4">
        <h1>
          <span className="font-bold">Баённома эгаси:</span> {ltd_name} АГТКШ №{" "}
          {station_number}
        </h1>
        <h1>
        ...
        <h1>
          <span className="font-bold">Баённома рақами:</span>{" "}
          {isEditing ? (
            <input
              type="text"
        ...
        <h1>
          <span className="font-bold">Баённома санаси:</span>{" "}
          {isEditing ? (
            <input
              type="date"
        ...
        <h1>
          <span className="font-bold">Баённома холати:</span>{" "}
