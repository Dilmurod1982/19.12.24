...
export default function AddNewEduc({ setSendingData, sendingData }) {
  ...
  const ecology = useAppStore((state) => state.educ);
  const setEcology = useAppStore((state) => state.setEduc);
  const base = "educ";
  ...
  useEffect(() => {
    if (sendingData) {
      ...
      registerDoc(user?.access_token, sendingData, base)
        .then((res) => {
          toast.dismiss();
          toast.success("Янги баённома мувафақиятли қўшилди!");
          setSendingData(null);
          setAddItemModal;
  ...
  }, [sendingData, ecology, user, setAddItemModal, setEcology]);
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги ўқитиш баённомасини қўшиш:
            </DialogTitle>
            <DialogDescription>
              Формани тўлдириб, янги баённома қўшинг.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="relative">
            <div className="w-[450px] p-2 flex flex-col gap-2 max-h-[450px] overflow-y-auto">
              ...
              <div className="w-full flex flex-col gap-2">
                <Label htmlFor="docNumber">Баённома рақами</Label>
                <Input
                  type="text"
                  id="docNumber"
                  name="docNumber"
                  ...
                  placeholder="Хулоса рақамини киритинг"
                  required
                />
              </div>
              <div className="w-full flex flex-col gap-2">
