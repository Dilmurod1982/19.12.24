...
export default function AddNewEcology({ setSendingData, sendingData }) {
  ...
  useEffect(() => {
    if (sendingData) {
      ...
      registerDoc(user?.access_token, sendingData, base)
        .then((res) => {
          toast.dismiss();
          toast.success("Янги хулоса мувафақиятли қўшилди!");
          setSendingData(null);
          setAddItemModal;
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги экология хулосасини қўшиш:
            </DialogTitle>
            <DialogDescription>
              Формани тўлдириб, янги хулосани қўшинг.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="relative">
            <div className="w-[450px] p-2 flex flex-col gap-2 max-h-[450px] overflow-y-auto">
              ...
              <div className="w-full flex flex-col gap-2">
                <Label htmlFor="ecology_number">Хулоса рақами</Label>
                <Input
                  type="text"
                  id="ecology_number"
                  name="ecology_number"
                  value={formState.ecology_number}
