...
export default function AddNewMol({ setSendingData, sendingData }) {
  ...
  }, [sendingData, mol, user, setAddItemModal, setMol]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги чақмоқ қайтаргич далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
