...
export default function AddNGSertificate({
  setSendingData,
  sendingData,
  stationId,
}) {
  ...
  useEffect(() => {
    if (sendingData) {
      setLoading(true);
      registerDoc(user?.access_token, sendingData, "ngsertificates")
        .then((res) => {
          toast.dismiss();
          ...
          getDocs(user?.access_token, "ngsertificates")
            ...
            .catch((error) =>
              console.error("Error fetching ngsertificates:", error)
            );
        })
        .catch(({ message }) => {
          if (message === "403") {
          ...
          <div className="w-[450px] p-2 flex flex-col gap-2">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <Input
                ...
                value={formState.ngsertificate_number}
