...
export default function AddNewTermometr({ setSendingData, sendingData }) {
  ...
  }, [sendingData, termometr, user, setAddItemModal, setTermometr]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги термометр сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
