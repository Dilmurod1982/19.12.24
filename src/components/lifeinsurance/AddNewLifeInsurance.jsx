...
export default function AddNewLifeInsurance({ setSendingData, sendingData }) {
  ...
  useEffect(() => {
    if (sendingData) {
      ...
      registerDoc(user?.access_token, sendingData, base)
        .then((res) => {
          toast.dismiss();
          toast.success("Янги полис мувафақиятли қўшилди!");
          setSendingData(null);
  ...
  }, [sendingData, lifeinsurance, user, setAddItemModal, setLifeinsurance]);
  ...
  useEffect(() => {
    const requiredFields = [
      ...
      formState.lifeinsurance_number,
      formState.issue,
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги ходимларни хаётини суғурталаш полиси қўшиш:
            </DialogTitle>
            <DialogDescription>
              Формани тўлдириб, янги полисни қўшинг.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="relative">
            <div className="w-[450px] p-2 flex flex-col gap-2 max-h-[450px] overflow-y-auto">
              ...
              <div className="w-full flex flex-col gap-2">
                <Label htmlFor="lifeinsurance_number">Полис рақами</Label>
                <Input
                  type="text"
                  id="lifeinsurance_number"
                  name="lifeinsurance_number"
                  value={formState.lifeinsurance_number} // Привязка значения
