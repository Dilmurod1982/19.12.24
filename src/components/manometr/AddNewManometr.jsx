...
export default function AddNewManometr({ setSendingData, sendingData }) {
  ...
  }, [sendingData, manometr, user, setAddItemModal, setManometr]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги Манометрлар сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
