...
export default function AddNewPpk({ setSendingData, sendingData }) {
  ...
  }, [sendingData, ppk, user, setAddItemModal, setPpk]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги ППК далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
