...
export default function ShaybaDetail() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/shayba/${id}`, {
        //zamena
        method: "PATCH",
        headers: {
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">Шайба сертификати</h1>
      </div>
      <div className="pl-10 flex flex-col gap-4">
        ...
        <h1>
          <span className="font-bold">Шайба сертификати рақами:</span>{" "}
          {isEditing ? (
            <input
              type="text"
