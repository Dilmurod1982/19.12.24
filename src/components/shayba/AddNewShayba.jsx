...
export default function AddNewShayba({ setSendingData, sendingData }) {
  ...
  }, [sendingData, shayba, user, setAddItemModal, setShayba]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги Шайба сертификатини қўшиш:
            </DialogTitle>
            <DialogDescription>
