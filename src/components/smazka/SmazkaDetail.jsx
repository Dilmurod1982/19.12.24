...
export default function SmazkaDetail() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/smazka/${id}`, {
        //zamena
        method: "PATCH",
        headers: {
    ...
    >
      <div className="flex justify-center">
        <h1 className="font-bold text-3xl">
          Технологик ва ёрдамчи ускуналарни текшириш ва мойлаш далолатномаси
        </h1>
      </div>
      <div className="pl-10 flex flex-col gap-4">
        <h1>
          <span className="font-bold">Далолатнома эгаси:</span> {ltd_name} АГТКШ
          № {station_number}
        </h1>
        <h1>
        ...
        <h1>
          <span className="font-bold">Далолатнома рақами:</span>{" "}
          {isEditing ? (
            <input
              type="text"
        ...
        <h1>
          <span className="font-bold">Далолатнома санаси:</span>{" "}
          {isEditing ? (
            <input
              type="date"
