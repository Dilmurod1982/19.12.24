...
export default function AddNewSmazka({ setSendingData, sendingData }) {
  ...
  }, [sendingData, smazka, user, setAddItemModal, setSmazka]); //zamena
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Технолгияларни мойлаш далолатномасини қўшиш:
            </DialogTitle>
            <DialogDescription>
