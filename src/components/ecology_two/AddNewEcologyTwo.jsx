...
export default function AddNewEcologyTwo({ setSendingData, sendingData }) {
        ...
        <DialogContent className="h-screen">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">
              Янги экология хулосасини ("Чиқинди") қўшиш:
            </DialogTitle>
            <DialogDescription>
          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="w-[450px] p-2 flex flex-col gap-2 max-h-[450px] overflow-y-auto">
              ...
              <div className="w-full flex flex-col gap-2">
                <Label htmlFor="docNumber">Хулоса рақами</Label>
                <Input
                  type="text"
                  id="docNumber"
                  name="docNumber"
